...
public final class BookmarkEvents {
    ...
    /**
     * The {@link com.jtechme.jumpgodev.fragment.BookmarksFragment} want to know the url (and title)
    ...
    /**
     * Sended by the {@link com.jtechme.jumpgodev.fragment.BookmarksFragment} when it wants to close
     * itself (generally in reply to a {@link com.jtechme.jumpgodev.bus.BrowserEvents.UserPressedBack}
     * event.
     */
